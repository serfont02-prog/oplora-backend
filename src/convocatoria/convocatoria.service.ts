...
export class ConvocatoriaService {
 ...
 async create(dto: CreateConvocatoriaDto): Promise<Convocatoria> {
  const convocatoria = this.convocatoriaRepo.create({
    ...
    ejercicios: dto.ejercicios as any,
    permiteBlancos: dto.permiteBlancos,
    fraccionPenalizacion: dto.fraccionPenalizacion,
    fraccionPenalizacionBlanco: (dto as any).fraccionPenalizacionBlanco,
    notaMinimaAprobado: dto.notaMinimaAprobado,
    diferenciasAnterior: dto.diferenciasAnterior,
    requisitos: dto.requisitos,
    formacionPosterior: dto.formacionPosterior,
    descripcionAdicional: dto.descripcionAdicional,
    generaBolsaEmpleo: dto.generaBolsaEmpleo,
    bolsaEmpleoDescripcion: dto.bolsaEmpleoDescripcion,
    plazasDesglose: dto.plazasDesglose as any,
...
async copiarConvocatoria(id: string): Promise<Convocatoria> {
  ...
  const nueva = await this.convocatoriaRepo.save(this.convocatoriaRepo.create({
    ...
    permiteBlancos: original.permiteBlancos,
    fraccionPenalizacionBlanco: original.fraccionPenalizacionBlanco,
