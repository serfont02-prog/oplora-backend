...
var flashcard_controller_1 = require("./flashcard.controller");
...
var FlashcardModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([flashcard_entity_1.Flashcard, repaso_fc_entity_1.RepasoFC, reto_fc_entity_1.RetoFC, resultado_reto_fc_entity_1.ResultadoRetoFC, articulo_entity_1.Articulo, tema_entity_1.Tema, usuario_entity_1.Usuario, configuracion_module_1.ConfiguracionModule]),
    ...
    var _classThis;
    var FlashcardModule = _classThis = /** @class */ (function () {
        function FlashcardModule_1() {
        }
        return FlashcardModule_1;
    }());
    __setFunctionName(_classThis, "FlashcardModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FlashcardModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FlashcardModule = _classThis;
}();
